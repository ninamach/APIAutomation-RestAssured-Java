    ...
    public static void main(String[] args) {		// TODO Auto-generated method stub
        ...
        String createIssueResponse 	= given()
                ...
                .body("{\n"
                        ...
                        + "}")
                .log().all()
                .post("rest/api/3/issue").then().log().all().assertThat().statusCode(201).contentType("application/json")		.extract().response().asString();		 		 JsonPath js = new JsonPath(createIssueResponse);
                ...
                given()
                        ...
                        .header("Authorization","Basic ")
                        .multiPart("file",new File("/Users/lien.mach/Downloads/IMG_0926.jpg")).log().all()
